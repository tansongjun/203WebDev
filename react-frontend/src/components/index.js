...
export { default as CreatePeopleComponent} from './CreatePeopleComponent';
export { default as UpdatePeopleComponent} from './UpdatePeopleComponent';
export { default as ViewPeopleComponent} from './ViewPeopleComponent';
