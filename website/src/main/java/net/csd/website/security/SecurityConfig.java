...
public class SecurityConfig {
    ...
    /**
     * @Bean annotation is used to expose a DaoAuthenticationProvider, type of
     ...
     *       bean in the Spring application context.
     *       Any calls to mvc() will then be intercepted to @return the bean
     *       instance.
     */
    @Bean
    ...
    /**
     * @Bean annotation is used to define a Cross-Origin Resource Sharing (CORS)
     *       settings configurer
     *       bean in the Spring application context.
     *       Any calls to corsConfigurer() will then be intercepted to
     *       Allow cross-origin requests from "http://localhost:3000" to any
     *       endpoint (/**)
     */
    @Bean
